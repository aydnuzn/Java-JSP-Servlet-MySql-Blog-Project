                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="margin: 0px; padding: 0px;">
                        <li style="border-bottom: 1px solid #1b28ac">
                            <a href="#" style="color:darkred;"><i class="fa fa-lock"></i> Şifre Değiştir</a>
                        </li>
                        <li>
...
<section id="main-content">
    <section class="wrapper">
        <div class="col-sm-6">
            ...
            %>
            <div style="color: red">
                <strong>Hata!</strong><%=changePasswordError%>
            </div>
            <% } %>
            ...
            <form action="change-password" method="post" >
                <div class="mb-3">
                    <input type="text" name="currentPassword" placeholder="Eski Şifre" class="form-control" required />
                </div>
                <div class="mb-3">
                    <input type="text" name="newPassword" placeholder="Yeni Şifre" class="form-control" required />
                </div>
                <button class="btn btn-success">Şifreyi Değiştir</button>
            </form>
        </div>
    </section>
</section>
